        ...
        <div class="card">
          <div class="card-body">
              <div id="tabComprobante" class="tabContenidoComprobante">
                          ...
                          <div class="card-body">
                              <div class="row">
                                  ...
                                  <div class="col-sm-4 form-group" title="Número de serie de la factura que usas para control interno, generalmente se usan letras">
                                      ...
                                      {!! Form::select('Comprobante_Serie',GenericClass::selectSeries(), null, [
                                            'class' => 'form-control',
                                  ...
                                  <div class="col-sm-4">
                                      <div class="form-group" title="Captura la fecha y hora  en que se realizó la operación, verifica que corresponda con tu horario local.">
                              ...
                              <div class="row">
                                  <div class="form-group col-md-4" title="Selecciona el tipo de moneda con la cual te pagan la factura.">
                                      ...
                                      {!! Form::select('Comprobante_Moneda', GenericClass::selectMonedas(), "MXN", [
                                            ...
                                            'onchange'=>'checkMoneda(this.value)'
                                            ]) !!}
                                  </div>
                                  <div class="col-sm-4">
                                      <div class="form-group" title="Cuando hayas seleccionado una moneda distinta de Peso Mexicano 'MXN', debes capturar la cantidad en pesos que equivale a una unidad de la moneda extranjera.">
                                  ...
                                  <div class="form-group col-sm-2" title="Atributo requerido para expresar si el comprobante ampara una operación de exportación.">
                                  ...
                                  <div class="form-group col-sm-2" title="Atributo requerido para incorporar el código postal del lugar de expedición del comprobante (domicilio de la matriz o de la sucursal).">
                              ...
                              <div class="row esMisCuentas">
                                  <div class="col-md-12">
                                      <div class="form-group" title="Registra las condiciones comerciales aplicables para el pago de la factura, por ejemplo plazos o políticas de crédito.">
                          ...
                          <div id="formContainer_Conceptos" class="container-forms" style="text-align:left; margin-bottom:10px">
                              @if(GenericClass::empresa()->ce==1)
                                  <form id="uploadProductos" style="display: inline">
                                      <a title="Subir conceptos desde archivo M" id="btnuploadProductos" class="btn btn-warning" style="float: right;position: absolute;right: 20px;">
                                      ...
                                      <div class="row">
                                          <div class="col-md-12">
                                              <div style="text-align:right;">
                                                  ...
                                                  <button type="button" class="btn btn-default" onclick="cancelarConcepto()">Cancelar</button>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
                  ...
                  <!-- INICIA SECCIÓN DE CFDI RELACIONADOS -->

                  <!-- <div class="card card-default">
                      <div class="card-header" title="Selecciona el recuadro para habilitar la información, en caso de que esta factura tenga alguna relación con otra que previamente se haya generado.">
                          <h4 class="card-title">
                              <input autocomplete="off" data-toggle="collapse" data-target="#card-relacionadas" class=" check-box" data-val="true" data-val-required="The Facturas relacionadas field is required." id="EditarCfdiRelacionados" name="EditarCfdiRelacionados" type="checkbox" value="false" onclick="habilitaFacturasRelacionadas();"><input name="EditarCfdiRelacionados" type="hidden" value="false" onclick="habilitaFacturasRelacionadas();">
                              <label style="margin: 0" class="control-label" for="EditarCfdiRelacionados">Facturas relacionadas:</label>
                          </h4>
                      </div>
                      <div id="card-relacionadas" class="card-collapse collapse">
                          <div class="card-body">
                              <div class="row">
                                  <div class="form-group col-md-8" title="Selecciona el efecto de esta factura sobre la relacionada.">
                                      {!! Form::label('CfdiRelacionados_TipoRelacionCat', 'Tipo de relación:') !!}
                                      {!! Form::select('CfdiRelacionados_TipoRelacionCat', GenericClass::selectTiposRelacion(), null, [
                                        'class' => 'form-control',
                                        'onchange'=>'asociaCatalogo($(this).closest(\'div.form-group\'), this)',
                                        'maxlength'=>255,
                                        'required']) !!}
                                  </div>
                                  ...
                                  <div class="col-md-4">
                                      <div class="form-group">
                                          <button style="margin-top: 32px" type="button" class="btn btn-primary" id="btnAceptarModal" onclick="cleanForm('CfdiRelacionado'); showForm('CfdiRelacionado')">Agregar folio</button>
                                      </div>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-md-12 hundido">
                                      <div id="formContainer_CfdiRelacionados.CfdiRelacionado" class="container-forms" style="text-align:left;">
                                          <div class="oculto" id="formularioCfdiRelacionado" data-title="Cfdi relacionado" method="post" novalidate="novalidate">
                                              <div id="errorCfdiRelacionado" class="alert alert-danger" style="display:none;">
                                                  <strong>¡Error de registro!</strong>
                                                  <span></span>
                                              </div>
                                              <div class="row">
                                                  <div class="col-md-8">
                                                      <div class="form-group" title="Captura el folio fiscal de la factura relacionada.">
                                                          <label class="control-label required" for="UUID">Folio fiscal:</label>
                                                          <input class="form-control text-box single-line" data-val="true" data-val-regex="Longitud y/o formato de datos inválidos." data-val-regex-pattern="[a-f0-9A-F]{8}-[a-f0-9A-F]{4}-[a-f0-9A-F]{4}-[a-f0-9A-F]{4}-[a-f0-9A-F]{12}" data-val-required="Este campo es obligatorio." id="UUID" name="UUID" type="text" value="" placeholder="FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF" maxlength="36" autocomplete="off">
                                                          <small><span class="field-validation-valid form-text form-text-error" data-valmsg-for="UUID" data-valmsg-replace="true"></span></small>
                                                      </div>
                                                  </div>
                                                  <div class="col-md-4">
                                                      <div class="form-group" style="padding-top: 32px">
                                                          <button type="button" class="btn btn-primary" id="btnAceptarModal" onclick="addEntityModal('CfdiRelacionado')">Agregar</button>
                                                          <button type="button" class="btn btn-default" id="btnCancelarModal" onclick="cleanForm('CfdiRelacionado'); hideForm('CfdiRelacionado');">Cancelar</button>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                              ...
                              <div class="row contenedor" id="contenedorCfdiRelacionado" style="">
                                  <div class="col-md-12" style="overflow:auto;">
                                      <table style="margin:0; margin-top: 15px" class="table table-bordered" id="CfdiRelacionados_CfdiRelacionado">
                                          <thead>
                                          <tr>
                                              <th>Folio fiscal</th>
                                              <th class="text-center" style="width:10%" class="acciones">Acciones</th>
                                          </tr>
                                          </thead>
                                          <tbody>
              ...
              <div id="tabReceptorEmisor" class="tabContenidoComprobante">
...
@section('js-scripts')
    <script>
        ...
        function checkMoneda(valor){
            if(valor=="MXN"){
                $("#Comprobante_TipoCambio").val(0);
            }
        }
        function descargarArchivos(obj){
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer text-right">
                    ...
                    <button class="btn btn-default guardaComprobante" onclick="guardarComprobante(this)"><i class="fas fa-save"></i> Guardar comprobante</button>
                    ...
                    <button id="btnDescarga" class="btn btn-warning oculto" onclick="descargarArchivos(this);"><i class="fas fa-file-zip-o"></i> Descargar archivos</button>
