...
<head>
    ...
    <meta name="description" content="Desarrollo web, noticias y mas.">
    <meta name="author" content="Jenice Vazquez">
    <meta property="og:locale" content="es_MX" />
    <meta property="og:title" content="{!! $articulo->titulo !!}" />
    <meta property="og:description" content="{!! $articulo->description !!}" />
    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://jenicevazquez.com/blog/{!! $articulo->id !!}/{!! $articulo->slug !!}" />

    @if($articulo->imagen!="")
        <meta property="og:image" content="{!! $articulo->imagen !!}" />
    @endif
    <meta property="og:sitename" content="jenicevazquez.com" />

    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@gojenice" />
    <meta name="twitter:creator" content="@gojenice" />
