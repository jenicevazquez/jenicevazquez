...
(function (global, factory) {
  ...
  var Layout = /*#__PURE__*/function () {
    ...
    _proto._init = function _init() {
      ...
      console.log("LAYOUT");
      var contentWrapperHeight = parseFloat($__default['default'](SELECTOR_CONTENT_WRAPPER).css('height'));
      var selectorSidebarHeight = parseFloat($__default['default'](SELECTOR_MAIN_SIDEBAR).css('height'));
      var footerHeight = $__default['default'](SELECTOR_FOOTER).outerHeight()+30+72;
      if(contentWrapperHeight>selectorSidebarHeight){
        $__default['default'](SELECTOR_CONTENT_WRAPPER).height(selectorSidebarHeight-footerHeight);
      }else{
        $__default['default'](SELECTOR_CONTENT_WRAPPER).height(contentWrapperHeight-footerHeight);
      }
